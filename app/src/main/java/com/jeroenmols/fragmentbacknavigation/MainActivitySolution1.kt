...
class MainActivitySolution1 : AppCompatActivity() {
    ...
    fun showPasswordFragment() {
        ...
        supportFragmentManager.beginTransaction().replace(R.id.framelayout_fragmentcontainer, PasswordFragment()).addToBackStack("").commit()
    }
    ...
    class TodayFragment : Fragment() {
        ...
        override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {
            ...
            loginButton.setOnClickListener({ (activity as MainActivitySolution1).showUserNameFragment()});
    ...
    class UserNameFragment : Fragment() {
        ...
        override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {
            ...
            usernameButton.setOnClickListener({ (activity as MainActivitySolution1).showPasswordFragment()});
            ...
            Handler().postDelayed(
                    {
                        ...
                        activity.onBackPressed() // APP WILL CRASH BECAUSE FRAGMENT IS DETACHED
                    }, 1000)
        }
